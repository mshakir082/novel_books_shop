...
import {getRomanse} from '../Redux/action'
...
const FantacyNovel = () => {
  ...
  const [selected,setSelected]=useState('')
   ...
   useEffect(()=>{
    ...
    dispatch(getRomanse(getBookParams))
  }
...
return (
  ...
  <Box>
      ...
      <Box  height='60px'>
          <Text fontSize='14px' textAlign='left' padding='1rem'>{`Home > Fantacy`}</Text>
      </Box>
      <Box>
      <Browse />
      </Box>
